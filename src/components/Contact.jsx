...
const Contact = () => {
  ...
  const submit=async()=>{
    await firebase.contact(name,email,query);
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Get information regarding order tracking, delivery date changes, help with returns (and refunds), and much more. Our Help Centre also provides more information that you may need regarding payments, shopping, and more.</p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          ...
          <p class="leading-normal my-5">KR Road, VV Puram
            <br/>Bangalore, 560004, Karnataka, India
          </p>
