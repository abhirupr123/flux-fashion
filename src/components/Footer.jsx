...
const Footer = () => {
  ...
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p class="mt-2 text-sm text-gray-500">The one stop destination for latest trending and affordable male fashion.</p>
    </div>
    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Get To Know Us</h2>
        <nav class="list-none mb-10">
          <li>
          ...
          <li>
            <a class="text-gray-600 hover:text-gray-800">Press Releases</a>
          </li>
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Consumer Policy</h2>
        <nav class="list-none mb-10">
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Let Us Help You</h2>
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-600 hover:text-gray-800">Privacy Policy</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">Your Account</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">Return Policy</a>
          </li>
          <li>
            <a class="text-gray-600 hover:text-gray-800">Offer T&C</a>
          </li>
        </nav>
      </div>
    </div>
  ...
  <div class="bg-indigo-200">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-black text-sm text-center sm:text-left">© 2023 Flux Fashion —
        <a href="#" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">Abhirup Roy</a>
      </p>
