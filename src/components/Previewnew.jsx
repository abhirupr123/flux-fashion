...
const Previewnew = () => {
    ...
    useEffect(()=>{
        firebase.getarrival(params.id).then((arr)=>setProd(arr.data()));        
    },[]);
    ...
    const additem=()=>{
      if(firebase.logged==true)
      {
        dispatch(add({name:prod.name,image:im,price:prod.price,qty:1,id:params.id,cat:"arr"}));
        alert('Added to cart');
      }      
      else 
      window.location='/signin';
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class=" w-[285px]  h-[510px] object-cover object-center rounded" src={im}/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          <div class="flex">
            ...
            <button class="border-2 border-gray-300 ml-1 bg-yellow-700 rounded-full w-6 h-6 focus:outline-none"></button>
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">₹ {prod.price} {`(40% off)`}</span>
          <button
          onClick={additem}
